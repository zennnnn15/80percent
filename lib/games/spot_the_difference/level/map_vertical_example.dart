...
import 'package:capstone_focus/games/spot_the_difference/level/game_levels_scrolling_map.dart';
import 'package:capstone_focus/games/spot_the_difference/level/model/point_model.dart';
...
class _MapHorizontalExampleState extends State<MapHorizontalExample> {
  ...
  void fillTestData() {
    for (int i = 1; i <11 ; i++) {
      points.add(PointModel(50, testWidget(i)));
    }
  }
