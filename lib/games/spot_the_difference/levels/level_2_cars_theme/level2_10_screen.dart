...
import '../level_3_cats_theme/level3_1_screen.dart';

class level2_10_screen extends StatefulWidget {
  ...
  @override
  _level2_10_screenState createState() => _level2_10_screenState();
}

class _level2_10_screenState extends State<level2_10_screen> {
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: ((context) =>
                          level2_1_screen()))); // Close the dialog and navigate back to GameScreen
                },
                child: Text('Play Again'),
              ),
              ElevatedButton(
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_2_cars_theme/10 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap(
                            "assets/spotthedif/level_2_cars_theme/10.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/level_2_cars_theme/10.png",
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_2_cars_theme/10 diff.png");
                      } else {
                        WrongImage();
                      }
                    },
