...
class level3_3_screen extends StatefulWidget {
  ...
  @override
  _level3_3_screenState createState() => _level3_3_screenState();
}

class _level3_3_screenState extends State<level3_3_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "aassets/spotthedif/level_3_cats_theme/3 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level3_4_screen(
                      initialScore: score,
                    ),
                  ),
                );
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/3 diff.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/level_3_cats_theme/3 diff.png",
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/3.png");
                      } else {
                        WrongImage();
                      }
                    },
