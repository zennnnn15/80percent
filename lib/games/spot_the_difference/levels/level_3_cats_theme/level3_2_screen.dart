...
class level3_2_screen extends StatefulWidget {
  ...
  @override
  _level3_2_screenState createState() => _level3_2_screenState();
}

class _level3_2_screenState extends State<level3_2_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_3_cats_theme/2 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level3_3_screen(
                      initialScore: score,
                    ),
                  ),
                );
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/2 diff.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/level_3_cats_theme/2 diff.png",
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/2.png");
                      } else {
                        WrongImage();
                      }
                    },
