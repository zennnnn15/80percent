...
class level3_1_screen extends StatefulWidget {
  const level3_1_screen({super.key});

  @override
  State<level3_1_screen> createState() => _level3_1_screenState();
}

class _level3_1_screenState extends State<level3_1_screen> {
  int score = 0;
  ...
  void correctImageTap(String tappedImage) {
    // Check which image was tapped
    if (tappedImage == "assets/spotthedif/level_3_cats_theme/1 diff.png") {
      // Deduct a life only if "soccer2.png" is tapped
      setState(() {
        score++;
      });
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level3_2_screen(
                      initialScore: 2,
                    ),
                  ),
                );
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/1.png");
                      } else {
                        WrongImage();
                      }
                    },
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/1 diff.png");
                      } else {
                        WrongImage();
                      }
                    },
