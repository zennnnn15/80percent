...
class level3_9_screen extends StatefulWidget {
  ...
  @override
  _level3_9_screenState createState() => _level3_9_screenState();
}

class _level3_9_screenState extends State<level3_9_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_3_cats_theme/9 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level3_10_screen(
                      initialScore: score,
                    ),
                  ),
                );
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/9.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/level_3_cats_theme/9.png",
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/9 diff.png");
                      } else {
                        WrongImage();
                      }
                    },
