...
class level3_8_screen extends StatefulWidget {
  ...
  @override
  _level3_8_screenState createState() => _level3_8_screenState();
}

class _level3_8_screenState extends State<level3_8_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_3_cats_theme/8 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level3_9_screen(
                      initialScore: score,
                    ),
                  ),
                );
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/8.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/level_3_cats_theme/8.png",
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/8 diff.png");
                      } else {
                        WrongImage();
                      }
                    },
