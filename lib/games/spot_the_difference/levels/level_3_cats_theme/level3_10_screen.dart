...
import '../level_4_clothes_theme/level4_1_screen.dart';

class level3_10_screen extends StatefulWidget {
  ...
  @override
  _level3_10_screenState createState() => _level3_10_screenState();
}

class _level3_10_screenState extends State<level3_10_screen> {
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: ((context) =>
                          level4_1_screen()))); // Close the dialog and navigate back to GameScreen
                },
                child: Text('Play Again'),
              ),
              ElevatedButton(
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_3_cats_theme/10 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/10.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/level_3_cats_theme/10.png",
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_3_cats_theme/10 diff.png");
                      } else {
                        WrongImage();
                      }
                    },
