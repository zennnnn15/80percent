...
import 'package:capstone_focus/games/spot_the_difference/levels/level_10_trees_theme/level10_4_screen.dart';
...
import 'package:capstone_focus/games/spot_the_difference/levels/level_3_cats_theme/level3_4_screen.dart';
import 'package:capstone_focus/games/spot_the_difference/levels/level_4_clothes_theme/level4_4_screen.dart';
import 'package:capstone_focus/games/spot_the_difference/levels/level_5_cups_theme/level5_4_screen.dart';
import 'package:capstone_focus/games/spot_the_difference/levels/level_6_dishes_theme/level6_4_screen.dart';
import 'package:capstone_focus/games/spot_the_difference/levels/level_7_dogs_theme/level7_4_screen.dart';
import 'package:capstone_focus/games/spot_the_difference/levels/level_8_house_theme/level8_4_screen.dart';
import 'package:capstone_focus/games/spot_the_difference/levels/level_9_shoes_theme/level9_4_screen.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class level10_3_screen extends StatefulWidget {
  ...
  @override
  _level10_3_screenState createState() => _level10_3_screenState();
}

class _level10_3_screenState extends State<level10_3_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "aassets/spotthedif/level_10_trees_theme/3 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level10_4_screen(
                      initialScore: score,
                    ),
                  ),
                );
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_10_trees_theme/3.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "aassets/spotthedif/level_10_trees_theme/3 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
                      child: Image.asset(
                        "assets/spotthedif/level_10_trees_theme/3 diff.png",
                        height: 150,
                        width: 150,
                      ),
                    ),
