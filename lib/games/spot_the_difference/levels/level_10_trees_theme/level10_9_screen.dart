...
import 'package:capstone_focus/games/spot_the_difference/levels/level_10_trees_theme/level10_10_screen.dart';
...
class level10_9_screen extends StatefulWidget {
  ...
  @override
  _level10_9_screenState createState() => _level10_9_screenState();
}

class _level10_9_screenState extends State<level10_9_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_10_trees_theme/9 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level10_10_screen(
                      initialScore: score,
                    ),
                  ),
                );
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_10_trees_theme/9.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_10_trees_theme/9 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
