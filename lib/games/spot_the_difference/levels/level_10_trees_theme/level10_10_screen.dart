...
class level10_10_screen extends StatefulWidget {
  ...
  @override
  _level10_10_screenState createState() => _level10_10_screenState();
}

class _level10_10_screenState extends State<level10_10_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_10_trees_theme/10 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_10_trees_theme/10.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_10_trees_theme/10 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
