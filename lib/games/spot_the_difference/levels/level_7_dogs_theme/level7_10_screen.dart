...
import '../level_8_house_theme/level8_1_screen.dart';

class level7_10_screen extends StatefulWidget {
  ...
  @override
  _level7_10_screenState createState() => _level7_10_screenState();
}

class _level7_10_screenState extends State<level7_10_screen> {
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: ((context) =>
                          level8_1_screen()))); // Close the dialog and navigate back to GameScreen
                },
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_7_dogs_theme/10 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_7_dogs_theme/10.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_7_dogs_theme/10 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
