...
class level8_3_screen extends StatefulWidget {
  ...
  @override
  _level8_3_screenState createState() => _level8_3_screenState();
}

class _level8_3_screenState extends State<level8_3_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "aassets/spotthedif/level_8_house_theme/3 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level8_4_screen(
                      initialScore: score,
                    ),
                  ),
                );
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_8_house_theme/3.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "aassets/spotthedif/level_8_house_theme/3 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
                      child: Image.asset(
                        "assets/spotthedif/level_8_house_theme/3 diff.png",
                        height: 150,
                        width: 150,
                      ),
                    ),
