...
import '../level_9_shoes_theme/level9_1_screen.dart';

class level8_10_screen extends StatefulWidget {
  ...
  @override
  _level8_10_screenState createState() => _level8_10_screenState();
}

class _level8_10_screenState extends State<level8_10_screen> {
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: ((context) =>
                          level9_1_screen()))); // Close the dialog and navigate back to GameScreen
                },
                child: Text('Play Again'),
              ),
              ElevatedButton(
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_8_house_theme/10 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_8_house_theme/10.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_8_house_theme/10 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
