...
class level6_2_screen extends StatefulWidget {
  ...
  @override
  _level6_2_screenState createState() => _level6_2_screenState();
}

class _level6_2_screenState extends State<level6_2_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_6_dishes_theme/2 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level6_3_screen(
                      initialScore: score,
                    ),
                  ),
                );
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_6_dishes_theme/2.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_6_dishes_theme/2 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
