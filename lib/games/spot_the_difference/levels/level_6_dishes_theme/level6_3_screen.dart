...
class level6_3_screen extends StatefulWidget {
  ...
  @override
  _level6_3_screenState createState() => _level6_3_screenState();
}

class _level6_3_screenState extends State<level6_3_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "aassets/spotthedif/level_6_dishes_theme/3 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level6_4_screen(
                      initialScore: score,
                    ),
                  ),
                );
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_6_dishes_theme/3.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "aassets/spotthedif/level_6_dishes_theme/3 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
                      child: Image.asset(
                        "assets/spotthedif/level_6_dishes_theme/3 diff.png",
                        height: 150,
                        width: 150,
                      ),
                    ),
