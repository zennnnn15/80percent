...
class GameScreen8 extends StatefulWidget {
  ...
  @override
  _GameScreen8State createState() => _GameScreen8State();
}

class _GameScreen8State extends State<GameScreen8> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage ==
        "assets/spotthedif/level_1_ball_theme/ball_correct_8.png") {
      setState(() {
        score++;
      });
      CorrectImage();
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_1_ball_theme/ball_wrong_8.png");
                      } else {
                        WrongImage();
                      }
                    },
