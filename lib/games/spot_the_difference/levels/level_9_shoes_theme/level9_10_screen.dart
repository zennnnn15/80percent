...
import '../level_10_trees_theme/level10_1_screen.dart';

class level9_10_screen extends StatefulWidget {
  ...
  @override
  _level9_10_screenState createState() => _level9_10_screenState();
}

class _level9_10_screenState extends State<level9_10_screen> {
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: ((context) =>
                          level10_1_screen()))); // Close the dialog and navigate back to GameScreen
                },
                child: Text('Play Again'),
              ),
              ElevatedButton(
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_9_shoes_theme/10 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_9_shoes_theme/10.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_9_shoes_theme/10 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
