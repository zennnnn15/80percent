...
class level9_5_screen extends StatefulWidget {
  ...
  @override
  _level9_5_screenState createState() => _level9_5_screenState();
}

class _level9_5_screenState extends State<level9_5_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_9_shoes_theme/5 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level9_6_screen(
                      initialScore: score,
                    ),
                  ),
                );
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_9_shoes_theme/5 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
                    ...
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_9_shoes_theme/5.png");
                        } else {
                          WrongImage();
                        }
                      },
