...
class level9_2_screen extends StatefulWidget {
  ...
  @override
  _level9_2_screenState createState() => _level9_2_screenState();
}

class _level9_2_screenState extends State<level9_2_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_9_shoes_theme/2 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level9_3_screen(
                      initialScore: score,
                    ),
                  ),
                );
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_9_shoes_theme/2.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_9_shoes_theme/2 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
