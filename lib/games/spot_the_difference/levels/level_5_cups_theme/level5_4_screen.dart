...
class level5_4_screen extends StatefulWidget {
  ...
  @override
  _level5_4_screenState createState() => _level5_4_screenState();
}

class _level5_4_screenState extends State<level5_4_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_5_cups_theme/4 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level5_5_screen(
                      initialScore: score,
                    ),
                  ),
                );
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_5_cups_theme/4.png");
                        } else {
                          WrongImage();
                        }
                      },
                    ...
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_5_cups_theme/4 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
