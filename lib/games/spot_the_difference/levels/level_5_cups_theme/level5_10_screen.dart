...
import '../level_6_dishes_theme/level6_1_screen.dart';

class level5_10_screen extends StatefulWidget {
  ...
  @override
  _level5_10_screenState createState() => _level5_10_screenState();
}

class _level5_10_screenState extends State<level5_10_screen> {
            ...
            children: <Widget>[
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: ((context) =>
                          level5_1_screen()))); // Close the dialog and navigate back to GameScreen
                },
                child: Text('Play Again'),
              ),
              ElevatedButton(
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_5_cups_theme/10 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
                  ...
                  children: <Widget>[
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_5_cups_theme/10.png");
                        } else {
                          WrongImage();
                        }
                      },
                  ...
                  children: <Widget>[
                    ...
                    GestureDetector(
                      onTap: () {
                        if (isCorrectImage()) {
                          correctImageTap(
                              "assets/spotthedif/level_5_cups_theme/10 diff.png");
                        } else {
                          WrongImage();
                        }
                      },
