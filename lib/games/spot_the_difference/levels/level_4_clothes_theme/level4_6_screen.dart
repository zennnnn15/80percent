...
class level4_6_screen extends StatefulWidget {
  ...
  @override
  _level4_6_screenState createState() => _level4_6_screenState();
}

class _level4_6_screenState extends State<level4_6_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_4_clothes_theme/6 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level4_7_screen(
                      initialScore: score,
                    ),
                  ),
                );
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/6.png"); // Updated to "6.png"
                      } else {
                        WrongImage();
                      }
                    },
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/6 diff.png"); // Updated to "6 diff.png"
                      } else {
                        WrongImage();
                      }
                    },
