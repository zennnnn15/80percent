...
class level4_9_screen extends StatefulWidget {
  ...
  @override
  _level4_9_screenState createState() => _level4_9_screenState();
}

class _level4_9_screenState extends State<level4_9_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_4_clothes_theme/9 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level4_10_screen(
                      initialScore: score,
                    ),
                  ),
                );
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/9.png");
                      } else {
                        WrongImage();
                      }
                    },
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/9 diff.png");
                      } else {
                        WrongImage();
                      }
                    },
