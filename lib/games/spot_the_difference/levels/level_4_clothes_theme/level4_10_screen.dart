...
import 'level4_1_screen.dart';

class level4_10_screen extends StatefulWidget {
  ...
  @override
  _level4_10_screenState createState() => _level4_10_screenState();
}

class _level4_10_screenState extends State<level4_10_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_4_clothes_theme/10 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/10.png");
                      } else {
                        WrongImage();
                      }
                    },
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/10 diff.png");
                      } else {
                        WrongImage();
                      }
                    },
