...
class level4_7_screen extends StatefulWidget {
  ...
  @override
  _level4_7_screenState createState() => _level4_7_screenState();
}

class _level4_7_screenState extends State<level4_7_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_4_clothes_theme/7 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level4_8_screen(
                      initialScore: score,
                    ),
                  ),
                );
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/7.png"); // Updated to "6.png"
                      } else {
                        WrongImage();
                      }
                    },
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/7 diff.png"); // Updated to "6 diff.png"
                      } else {
                        WrongImage();
                      }
                    },
