...
class level4_5_screen extends StatefulWidget {
  ...
  @override
  _level4_5_screenState createState() => _level4_5_screenState();
}

class _level4_5_screenState extends State<level4_5_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "assets/spotthedif/level_4_clothes_theme/5 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level4_6_screen(
                      initialScore: score,
                    ),
                  ),
                );
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/5.png"); // Updated to "5.png"
                      } else {
                        WrongImage();
                      }
                    },
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/5.png"); // Updated to "5 diff.png"
                      } else {
                        WrongImage();
                      }
                    },
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/5 diff.png"); // Updated to "5.png"
                      } else {
                        WrongImage();
                      }
                    },
