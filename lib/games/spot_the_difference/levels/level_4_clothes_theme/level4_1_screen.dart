...
import 'package:capstone_focus/games/spot_the_difference/levels/level_2_cars_theme/level2_2_screen.dart';
import 'package:capstone_focus/games/spot_the_difference/levels/level_3_cats_theme/level3_2_screen.dart';
import 'package:capstone_focus/games/spot_the_difference/levels/level_4_clothes_theme/level4_2_screen.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class level4_1_screen extends StatefulWidget {
  level4_1_screen({super.key});

  @override
  _level4_1_screenState createState() => _level4_1_screenState();
}

class _level4_1_screenState extends State<level4_1_screen> {
  int score = 0;
  ...
  void correctImageTap(String tappedImage) {
    // Check which image was tapped
    if (tappedImage == "assets/spotthedif/level_4_clothes_theme/1 diff.png") {
      // Deduct a life only if "soccer2.png" is tapped
      setState(() {
        score++;
      });
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level4_2_screen(
                      initialScore: 2,
                    ),
                  ),
                );
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/1.png");
                      } else {
                        WrongImage();
                      }
                    },
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/1 diff.png");
                      } else {
                        WrongImage();
                      }
                    },
