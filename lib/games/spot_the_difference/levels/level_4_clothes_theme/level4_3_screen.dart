...
class level4_3_screen extends StatefulWidget {
  ...
  @override
  _level4_3_screenState createState() => _level4_3_screenState();
}

class _level4_3_screenState extends State<level4_3_screen> {
  ...
  void correctImageTap(String tappedImage) {
    ...
    if (tappedImage == "aassets/spotthedif/level_4_clothes_theme/3 diff.png") {
      setState(() {
        score++;
      });
      CorrectImage();
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => level4_4_screen(
                      initialScore: score,
                    ),
                  ),
                );
                ...
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        ...
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/3 diff.png");
                      }
                    },
                    child: Image.asset(
                      "assets/spotthedif/level_4_clothes_theme/3 diff.png",
                  ...
                  GestureDetector(
                    onTap: () {
                      if (isCorrectImage()) {
                        correctImageTap(
                            "assets/spotthedif/level_4_clothes_theme/3.png");
                      } else {
                        WrongImage();
                      }
                    },
